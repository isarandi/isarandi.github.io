smplfitter.pt.bodyfitter.BodyFitter
===================================

.. py:class:: smplfitter.pt.bodyfitter.BodyFitter(body_model, num_betas = 10, enable_kid = False, vertex_subset = None, joint_regressor = None)
