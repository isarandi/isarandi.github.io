smplfitter.pt.handreplacer.BodyFitter
=====================================

.. py:class:: smplfitter.pt.handreplacer.BodyFitter(body_model, num_betas = 10, enable_kid = False, vertex_subset = None, joint_regressor = None)
